...
excerpt: "Exploration of a novel approach to wave-based optimization problems with high computational complexity (e.g., designing an optical computer).<br/><img src='/images/qcqp/naked_demo_opt.png' width='300'>"
collection: portfolio
date: 2025-11-06
paperurl: 'https://johndedyo.github.io/files/qcqp/Dedyo_Goldwater_Research_Essay.pdf'
---

[Download Paper](https://johndedyo.github.io/files/qcqp/Dedyo_Goldwater_Research_Essay.pdf)
